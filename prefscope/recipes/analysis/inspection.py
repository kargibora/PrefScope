"""Optional annotation and presence inspection functions for a Lens."""
...
def presence(lens, codes, *, feature_ids=None, policy: str = "calibrated"):
    ...
    Returns a :class:`prefscope.recipes.analysis.presence.PresenceMatrix`.  The default
    ...
    *,
    ...
    if "semantic_threshold" in table:
        ...
        if "presence_pass" in table:
            calibration_pass = table["presence_pass"].map(annotation_flag)
        else:
