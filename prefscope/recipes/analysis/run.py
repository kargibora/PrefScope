...
wrap the generic cores in ``pipeline`` so any (codes, meta) — from a Lens
...
from prefscope.recipes.pipeline.diagnose import diagnose_features
from prefscope.recipes.pipeline.winrelevance import win_relevance
...
def feature_preference_relevance(
    ...
    from prefscope.recipes.analysis.grouping import resolve_group_ids
