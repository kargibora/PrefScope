...
from prefscope.recipes.analysis.presence import annotation_flag, concept_presence
from prefscope.data import pair_schema
from prefscope.recipes.analysis.text_features import encode_texts
from prefscope.recipes.analysis.inspection import concept_activations
...
def export_concepts(
    ...
    *,
    ...
    empty = concept_activations(lens,
    ...
    try:
        for start in range(0, len(source), int(batch_size)):
            ...
            for side, completion_col in sides:
                ...
                codes = encode_texts(lens, prompts, completions)
                long = concept_activations(lens,
