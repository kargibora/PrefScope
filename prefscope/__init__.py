...
from prefscope.core.representation import (
    CallableRepresentationSource, RepresentationBatch, RepresentationSource,
)
...
from prefscope.api.analysis import (
    ...
    DatasetAnalysisResult, FeatureArtifactDiagnostics, OutcomeAssociations, OutcomeSpec, PairedConceptShift,
    PreferenceLengthConfounds, PairedOutcomeShifts, PairedOutcomeSpec, PromptConditionedOutcomeShifts,
    analyze_dataset,
)
from prefscope.analysis import diagnose, evaluate_preference, feature_preference_relevance
from prefscope.analysis import (
    NormalizedOutcomes, OutcomeAssociationResult, associate_outcomes,
    associate_outcomes_by_group, concept_presence, normalize_outcomes,
...
def load_lens(path, *, device: str = "cpu", revision: str | None = None,
              cache_dir=None, token=None, local_files_only: bool = False,
              subfolder: str | None = None, annotations=None,
              embedding_cache=None, embed_backend: str = "hf",
    ...
    if str(path).startswith("hf://"):
        ...
        if subfolder is not None and source_subfolder is not None:
            raise ValueError("specify the Hub subfolder in either path or subfolder=, not both")
        return Lens.from_pretrained(
            ...
            embedding_cache=embedding_cache, embed_backend=embed_backend,
...
__all__ = [
    ...
    "PairItem", "Dataset", "RepresentationBatch", "RepresentationSource",
    "CallableRepresentationSource", "EmbeddingRepresentationSource",
    "PrecomputedRepresentationSource", "LensBackend", "LensCapabilities", "pair_item_metadata",
    "FeatureMatrix", "FeatureBatch", "TableContract", "OutcomeSpec",
    "AnalysisDataset",
    "AnalysisArtifact", "AnalysisComponent", "FeatureArtifactDiagnostics",
    "OutcomeAssociations",
    "PreferenceLengthConfounds", "PairedOutcomeShifts", "PairedOutcomeSpec",
    "PromptConditionedOutcomeShifts",
    "PairedConceptShift", "AnalysisPlan",
    "DatasetAnalysisResult", "analyze_dataset", "preference_relevance",
    "load_feature_batch", "save_feature_batch",
    "TableDataset", "HuggingFaceDataset", "ColumnMapping", "prepare_dataset",
    "AnalyzeConfig", "run_analysis",
    ...
    "NormalizedOutcomes", "OutcomeAssociationResult", "normalize_outcomes",
    "associate_outcomes", "associate_outcomes_by_group",
    "concept_presence", "paired_concept_shift", "paired_concept_shift_by_region",
    "summarize_response_scope", "ResponseComparison", "compare_encoded_responses",
